...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to SHADOW-BOT voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional SHADOW-BOT features. Turn your account into a ai chatbot!'
    already_on = 'SHADOW-BOT artificial intelligence is already fully functional.'
    already_off = 'SHADOW-BOT artificial intelligence is currently running semi-functional.'
    succ_on = 'SHADOW-BOT Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'SHADOW-BOT Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'AZ') {
